...
// Copyright (c) 2018 The Zenad developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000001ad3aecaa0cb4e169759618a3236fca390a765c05fa92216acec9c85502"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526566700, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 4000; //Params().MasternodeColleteralLimxDev()
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1526566700;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21195680;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000001ad3aecaa0cb4e169759618a3236fca390a765c05fa92216acec9c85502"));
        assert(genesis.hashMerkleRoot == uint256("0x56a0d1d9c05801204001839ade9e5ec3358a35c85a89de5fcf1fc4a42b3c7a96"));
        

        vSeeds.push_back(CDNSSeedData("62.121.95.120", "62.121.95.120"));
        ...
        nStartMasternodePayments = 1526566700; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1526566701;
        genesis.nNonce = 21855963;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000e86543f6e33703e9fcd369a51ce38323d220dff3e77fcb3c509be12fb0"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Zenad BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Zenad BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Zenad BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1526566701;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1526566702;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x43e4c736dc6f1dd2b6014d55972185cca4311037fa6b704ddf28c55a45ba1ea7"));
